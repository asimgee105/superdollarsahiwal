                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              title: const Text('Edit Profile Details', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                            ...
                            ListTile(
                              ...
                              title: const Text('Orders & Return History', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey),
                              onTap: () => context.go('/orders'),
                            ),
                            const Divider(height: 1, indent: 16, endIndent: 16),
                            ListTile(
                              leading: const Icon(Icons.payment_outlined, color: Colors.grey),
                              title: const Text('Saved Payment Cards', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey),
                              onTap: () => context.go('/saved-cards'),
                            ),
                            const Divider(height: 1, indent: 16, endIndent: 16),
                            ListTile(
                              leading: const Icon(Icons.card_giftcard_outlined, color: Colors.grey),
                              title: const Text('Gift Cards Balance', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey),
                            ...
                            ListTile(
                              ...
                              title: const Text('Super Dollar Insider Club', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey),
                            ...
                            ListTile(
                              ...
                              title: const Text('Security & Active Sessions', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey),
                            ...
                            ListTile(
                              ...
                              title: const Text('Live Chat Helpdesk', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey),
                            ...
                            ListTile(
                              ...
                              title: const Text('Fashion lookbooks & Diaries', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey),
                              onTap: () => context.go('/lookbooks'),
                            ),
                            const Divider(height: 1, indent: 16, endIndent: 16),
                            ListTile(
                              leading: const Icon(Icons.help_outline, color: Colors.grey),
                              title: const Text('FAQs & Store Policies', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                              trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: Colors.grey),
                              onTap: () => context.go('/faq-policies'),
                            ),
                          ],
                        ),
                      ),
